...
**Current Vulnerability**: Bot token `YOUR_BOT_TOKEN_REDACTED` is hardcoded in "Send Typing" and "Send Typing2" HTTP request nodes.
...
```json
{
  ...
  "type": "n8n-nodes-base.httpRequest",
  "parameters": {
    "url": "https://api.telegram.org/botYOUR_BOT_TOKEN_REDACTED/sendChatAction"
  }
}
```
