...
### 4. Оплатите тестовой картой Мир

| Поле | Значение |
|------|----------|
| **Номер карты** | `2202 4743 0132 2987` |
...
### Сценарий 2: 3D Secure

1. Выберите любой тариф
2. Введите карту `2200 0000 0000 0004`
3. Оплатите
4. **Ожидание**:
...
1. Выберите любой тариф
2. Введите карту `2200 0000 0000 0053`
3. Оплатите
4. **Ожидание**:
   - Платёж отклонён
...
### Сценарий 4: Карта просрочена

1. Выберите любой тариф
2. Введите карту `2200 0000 0000 0038`
3. Оплатите
4. **Ожидание**:
   - Платёж отклонён
   - Причина: `card_expired`

### Сценарий 5: Подозрение на мошенничество

1. Выберите любой тариф
2. Введите карту `2200 0000 0000 0046`
3. Оплатите
4. **Ожидание**:
   - Платёж отклонён
   - Причина: `fraud_suspected`

### Сценарий 6: Общий отказ банка

1. Выберите любой тариф
2. Введите карту `2202 2022 1231 2379`
3. Оплатите
4. **Ожидание**:
   - Платёж отклонён
...
| Подозрение на мошенничество | `2200 0000 0000 0046` |
| Общий отказ банка | `2202 2022 1231 2379` |

---

## Все тестовые карты YooKassa
...
| Ошибка | Мир | Mastercard | Visa |
|--------|-----|------------|------|
| Недостаточно средств | `2200 0000 0000 0053` | `5555 5555 5555 4600` | `4562 2655 8771 2390` |
| Карта просрочена | `2200 0000 0000 0038` | `5555 5555 5555 4543` | `4141 4354 1263 0840` |
| Подозрение на мошенничество | `2200 0000 0000 0046` | `5555 5555 5555 4568` | `4483 2742 8229 9972` |
| Общий отказ банка | `2202 2022 1231 2379` | `5555 5555 5555 4527` | `4889 9717 0658 8753` |
