...
### Added
- **pages**: add 1 source file(s), update 2 source file(s), +2 more (79075b1)
...
### Added
- **admin**: add dynamic admin_emails table for flexible admin management (74f6f8b)

## [0.6.12] - 2026-01-30

### Added
- **admin**: add 2 source file(s), update 6 source file(s), +1 more (e756fc8)
...
### Fixed
- **admin**: update 2 source file(s) (4362162)

## [0.6.8] - 2026-01-11

### Fixed
- **admin**: update 2 source file(s) (3127cd3)

## [0.6.7] - 2026-01-11

### Fixed
- **admin**: update 1 source file(s) (e3771b5)

## [0.6.6] - 2026-01-11

### Fixed
- **admin**: update 3 source file(s) (f8411ac)

## [0.6.5] - 2026-01-11

### Fixed
- **lib**: update 2 source file(s) (c920240)

## [0.6.4] - 2026-01-09

### Fixed
- **admin**: update 2 source file(s) (7cce520)

## [0.6.3] - 2026-01-09

### Fixed
- **lib**: update 2 source file(s) (6182894)
...
### Fixed
- **hooks**: update 2 source file(s) (0e5a4fc)
...
### Fixed
- **admin**: update 1 source file(s) (b5fe4e6)

## [0.5.52] - 2026-01-06

### Fixed
- **lib**: update 2 source file(s) (578a42e)
...
### Added
- **photo-analysis**: add topic selection for Basic vs Pro readings (807b74b)

## [0.5.48] - 2026-01-06

### Added
- **admin**: add 4 source file(s), update 11 source file(s), +3 more (c738bbf)

## [0.5.47] - 2026-01-06

### Fixed
- **admin**: update 5 source file(s) (a3f7e83)
...
### Fixed
- **share**: use native navigator.share when available (673bdc8)
...
### Fixed
- **share**: increase share text limit from 500 to 2000 characters (4d4ff52)

## [0.5.40] - 2026-01-04

### Changed
- **share**: share text instead of image, copy to clipboard in WebApp (4c2fdc5)

## [0.5.39] - 2026-01-04

### Fixed
- **share**: on desktop WebApp download image instead of navigator.share() which opens Windows system dialog (5409544)
...
### Fixed
- **auth/link**: migrate analysis_history and conversations during account merge (fe6cecb)
...
### Fixed
- **historyService**: add Telegram JWT support for analysis history (4eb8ea2)
...
### Fixed
- **components**: update 1 source file(s) (7771749)

## [0.5.30] - 2026-01-04

### Fixed
- **services**: update 1 source file(s) (84e30ad)
...
### Fixed
- **src/App.tsx**: update 2 source file(s) (a94b0ac)
...
### Fixed
- **components**: update 3 source file(s) (04aa5ef)

## [0.5.25] - 2026-01-03

### Fixed
- **components**: update 2 source file(s) (cfbd114)
...
### Fixed
- **lib**: update 2 source file(s) (1b09500)
...
### Fixed
- **utils**: update 1 source file(s) (4fa1858)
- **telegram**: use HEX colors directly from Telegram theme (9d441e0)

## [0.5.14] - 2025-12-31

### Added
- **admin**: add 8 source file(s), update 6 source file(s), +1 more (c2fc5c6)
...
### Fixed
- **src/main.tsx**: update 3 source file(s), update docs (69b5ca0)
